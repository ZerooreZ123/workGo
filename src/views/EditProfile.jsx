...
class EditProfile extends Component {
  constructor() {
    ...
    this.state = {
      ...
      departmentId: window.Person.buMenId, //部门Id
      mask: false, //默认不显示部门
    ...
    return (
      <div className={styles.container}>
        ...
        <div className={styles.bottomBar}>
          <div onClick={ev => this.showDepartment(ev)} className={styles.add}>
            选择部门<Direction checked={true} />
          </div>
          <div onClick={ev => this.determineDepartment(ev)} className={styles.editor}>
            确定
          </div>
        </div>
