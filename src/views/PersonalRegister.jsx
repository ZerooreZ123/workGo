...
class PersonalRegister extends Component {
  constructor() {
    ...
    this.state = {
      ...
      inputText: window.goGoPhone, //输入的手机号
      inputValue: "", //输入的验证码
      code: "" //获得的验证码
    };
  }
    ...
    return (
      <div className={styles.container}>
        ...
        <div className={inputText ? styles.showBorder : styles.invite}>
          ...
          <div className={styles.inputClass}>{inputText}</div>
        </div>
        ...
        <div className={styles.next}>
          <div className={inputText && inputValue ? styles.nextCan : styles.nextStep} onClick={ev => this.goToNextStep(ev)}>
            下一步
          </div>
        </div>
