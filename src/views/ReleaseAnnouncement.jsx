...
class ReleaseAnnouncement extends Component{
    ...
    startDate() {
        ...
        this.setState({
            ...
            chooseDay:date.getFullYear() + '-' + (date.getMonth() + 1) + '-' + date.getDate()
        });
    }
    handleDayClick(day) {
        ...
        if(parseInt(R2) <= parseInt(R1) ){
            this.setState({selectedDay:myDate.getFullYear() + '-' + (myDate.getMonth() + 1) + '-' + myDate.getDate(),copyMask:false});
            this.hideMask1();
        }else{
    ...
    selectDayClick(day) {
        ...
        if(parseInt(R4) <= parseInt(R3)) {
            this.setState({chooseDay:myDate.getFullYear() + '-' + (myDate.getMonth() + 1) + '-' + myDate.getDate(),copyMask:false});
            this.hideMask2();
        }else{
            this.hideMask2();
    ...
    delete(i) {
        ...
        this.setState({imgBox:this.state.imgBox,imgSrcConcat:this.state.imgSrcConcat});
    }
